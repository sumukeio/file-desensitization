# 项目文档总索引 (Documentation Index)

> **权威性声明**：本文档是仓库内所有业务规范、产品方案与技术文档的单一事实来源与路由导航表。
...
## 🧭 快速查找指南
- **想了解脱敏规则设计与为什么这样脱敏？** $\rightarrow$ 请阅读 [`docs/excel_desensitization_solution.md`](file:///e:/AIProject/File%20Desensitization/docs/excel_desensitization_solution.md) 第二章。
